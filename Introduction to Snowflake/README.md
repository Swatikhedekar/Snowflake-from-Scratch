## I. Introduction to Snowflake: 
This first course from **Datacamp** Covers Snowflake basics including navigating Snowsight, executing SQL queries, role-based access control, data ingestion, query monitoring, and performance optimization for modern data warehousing.
...
4. Analyzing the sales amount
5. Investingating query and copy History
6. Vieving query details
7. exploring python worksheets

## II. Snowsight in Action: Amnaging Data & access
